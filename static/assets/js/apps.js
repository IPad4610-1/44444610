...
var apps = {
  ...
  GPT: { imageUrl: "/assets/img/gpt.webp", onClick: gpt },
  'Gemini': { imageUrl: "/assets/img/gemini.webp", onClick: gemini },
  電話: { imageUrl: "/assets/img/discord.webp", onClick: discord },
  X: { imageUrl: "/assets/img/twitter-x.webp", onClick: twitter },
  ...
  Crazy: { imageUrl: "/assets/img/crazygames.webp", onClick: crazygms },
  'Y8 ': { imageUrl: "/assets/img/y8.webp", onClick: y8 },
  'fun': { imageUrl: "/assets/img/neal.webp", onClick: nf},
  'Now': { imageUrl: "/assets/img/geforcenow.webp", onClick: geforce },
  'GG': { imageUrl: "/assets/img/nowgg.webp", onClick: ng },
  ...
  よーつべ: { imageUrl: "/assets/img/youtube.webp", onClick: yt },
